<?php
$mailto = "turnbulr@mail.gvsu.edu";//Enter YOUR email address here surrounded by the quotes. Before testing the form on the EOS machines, be sure the permissions for this file are set (page 18 of the Setup Website Hosting instructions). Also, if you do not immediately receive an email, check your junk folder. Do not change anything else in this php file except for your email address. Doing so can cause problems on the server and Lawrence, our server administrator, will not be a happy camper.
